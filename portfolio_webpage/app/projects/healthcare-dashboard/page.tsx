  ...
  return (
    <div className="max-w-6xl mx-auto py-16 px-4 space-y-10">
      ...
      <p className="text-muted-foreground text-lg">
        Data visualization project analyzing hospital readmission trends by diagnosis, treatment, and patient demographics to identify high-risk groups and improve care outcomes.
      </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-10">
        {[
          { src: "/images/healthcare-1-overview.png", alt: "Overview", caption: "Dashboard Overview" },
          { src: "/images/healthcare-2-dashboard-1.png", alt: "By Diagnosis & Age", caption: "Readmission by Diagnosis & Age" },
          { src: "/images/healthcare-3-dashboard-2.png", alt: "By Treatment & Stay", caption: "Readmission by Treatment & Stay" },
          { src: "/images/healthcare-4-takeaways.png", alt: "Takeaways", caption: "Project Takeaways" },
        ].map(({ src, alt, caption }) => (
